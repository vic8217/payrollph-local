...
export default function ManagementReports() {
  ...
  return <div className="w-full space-y-4 p-4 md:p-6">
    ...
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-6">
      ...
      <KpiCard label="Overtime Cost" value={money(overtimeCost)} icon={Clock3} color="bg-violet-100 text-violet-700" change={percentChange(overtimeCost, previousOtCost)} inverse onClick={() => setSelectedKpi('overtime')}/>
      <KpiCard label="Night Differential" value={money(nightDiff)} icon={Moon} color="bg-orange-100 text-orange-600" change={percentChange(nightDiff, previousNightDiff)} inverse onClick={() => setSelectedKpi('nightDiff')}/>
