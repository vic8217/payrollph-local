...
export const ROLE_PERMISSIONS = {
  super_admin: ["*"],
  admin: ["employees", "attendance", "biometric_devices", "biometric_mapping", "schedule", "leave", "holidays", "no_work_days", "payroll", "special_rates", "special_payroll", "thirteenth_month", "separation_pay", "statutory_rates", "deductions", "cash_advance", "users", "passcode_audit", "payslip_receipts", "company_profile", "shift_settings", "employee_portal"],
...
export const ROUTE_PERMISSIONS = {
  ...
  "/attendance": "attendance", "/attendance/time-in-reviews": "attendance", "/biometric-devices": "biometric_devices", "/biometric-mapping": "biometric_mapping", "/work-schedule": "schedule",
